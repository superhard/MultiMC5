...
ResourcePtr Resource::create(const QString &resource)
{
	ResourcePtr ptr = m_resources.contains(resource)
...
ResourcePtr Resource::applyTo(ResourceObserver *observer)
{
...
ResourcePtr Resource::applyTo(QObject *target, const char *property)
{
...
ResourcePtr Resource::placeholder(ResourcePtr other)
{
	m_placeholder = other;
